	...
	<div class="row">
		<div class="col-md-12">
			<div class="product-title">
				<a class="title"><spring:message code="home.topdc" /></a> <a
					class="linktoProduct" href="product/special/salesoff.htm"><spring:message
						code="home.topdc.more" /></a>
			</div>
		</div>
	</div>
				...
				<div class="box">
					<ul>
						...
						<li class="productPrice">
							<div style="display: inline-block;" class="new-price">
								<fmt:formatNumber maxFractionDigits="2">${p.unitPrice*(1-p.discount)}</fmt:formatNumber>
								$
							</div>
							<div style="display: inline-block;" class="old-price">
								<fmt:formatNumber maxFractionDigits="2">${p.unitPrice}</fmt:formatNumber>
								$
							</div>
							<div style="display: inline-block;" class="remains">
								<spring:message code="home.topdc.remain" />
								${p.quantity}
							</div>
						</li>
						<li class="feature"><a class="discount">-<fmt:formatNumber
									value="${p.discount}" type="percent" /></a></li>
					</ul>
				</div>
			</c:forEach>
		</div>
