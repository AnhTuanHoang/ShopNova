    ...
    <div class="container">
        ...
        <footer class="row" style="text-align: center; vertical-align: center;">
			<div id="footer1" class="col-md-2">
				<br>
				<h1><a href="#" title="EShop.com">EShop.com</a></h1>
			</div>
			<div class="col-md-6">
				...
				<div>Website: http://EShop.com</div>
				<div>Copyright © 2018 EShop.com . All Rights Reserved</div><br>
			</div>
				<br>
			<div class="col-md-4" id="footer3">
				<div class="title_footer">
					<div style="font-size:20px;"><b><spring:message code="footer.customerservice"/></b></div>
					<p><img style="max-width: 35px; font-size: 20px;" alt="" src="images/contacts/phone_icon.png">0965.070.533 (từ 8h-22h, kể cả T7-CN)</p>
				</div>
				<hr>
				<ul class="social" >
					<li><a style="font-size: 20px;"><spring:message code="footer.contact"/></a></li>
					<li><a href="https://www.facebook.com/StLweLL"><img src="images/contacts/facebook_social.png" alt="" /></a></li>
